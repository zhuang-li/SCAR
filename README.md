...
The models here are pre-trained on a dataset consisting primarily of open-domain data, available at `https://github.com/zhuang-li/SCAR/tree/main/data/ranker_data/mix_code_open/gpt_35`.
